...
session_start();
require_once "conn.php"; // Selecting Database from Server
  ?>
<!DOCTYPE html>
<html lang="en">
   <!-- Basic -->
               ...
               <div class="header-top">
                  <div class="row">
                     <div class="col-md-6">
                        <div class="full">
                           <div class="logo">
                              <a href="index.html"><img src="images/Capturewin_prev_ui.png" alt="#" /></a>
                           </div>
                        </div>
                     </div>
                     <div class="col-md-6">
                                 ...
                                 <div class="search-bar">
                                    <div id="imaginary_container">
                                       <div class="input-group stylish-input-group">
                                         <a href="search.php"> <input type="text" class="form-control"  placeholder="Search" ></a>
                     ...
                     <div class="carousel-caption">
                        ...
                        <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12">
                           <div class="slider-contant" data-animation="animated fadeInRight">
                              <h3>If you Don’t Practice<br>You <span class="color-yellow">Don’t Derserve</span><br>to be discovered!</h3>
            ...
            <div class="news">
               <div class="container">
                  <div class="heading-slider">
                     ...
                     <h1>
                     <a href="" class="typewrite" data-period="2000" data-type='[ "We got you covered in the discovery of young talents", "Top young talents you can verify anyday, anytime", "It is a long established fact that a viewer will be impressed by the viewable content of some of the talents when watching."]'>
         ...
         <div class="container">
            <div class="main-heading-holder">
               <div class="main-heading sytle-2">
                  <h2>Meet Your Top Teenage Talents</h2>
                  <p>Selected Randomly. Click Image(s) to Watch !!!</p>
               </div>
            </div>
            <div id="team-slider">
               <div class="container">
...
?>
                        <img src="<?php echo $r['filename'] ?>" widht="90px" height="300px">
                        <div class="player-name">
                           
                           <div class="desination-2"><?php  echo $r['wing'];?></div>
                           <h5><?php  echo $r['fullname'];?></h5>
                           <span class="player-number"><?php  echo $r['num'];?></span><?php }?>
                        </div>
                        <div class="overlay">
...
?>
                  ...
                  <div class="col-md-3">
                               <?php
$sql = "SELECT * FROM team where id = '6'";
               $res = mysqli_query($connection, $sql); 
               $cnt=1;
               while ($r = mysqli_fetch_assoc($res)) {
?>
                  ...
                  <div class="col-md-3">
                     <?php
$sql = "SELECT * FROM team where id = '7'";
               $res = mysqli_query($connection, $sql); 
               $cnt=1;
               while ($r = mysqli_fetch_assoc($res)) {
?>
